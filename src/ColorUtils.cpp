...
void ColorUtils::valToRGB(double val0To1, unsigned char& r, unsigned char& g, unsigned char& b)
{
...
*/
void ColorUtils::wavelengthToRGB(double wavelength, unsigned char& r, unsigned char& g, unsigned char& b) {
    double x, y, z;
...
*/
void ColorUtils::srgbXYZ2RGB(double x, double y, double z, double& r, double& g, double& b) {
...
*/
double ColorUtils::srgbXYZ2RGBPostprocess(double c) {
...
*/
void ColorUtils::cie1931WavelengthToXYZFit(double wavelength, double& x, double& y, double& z) {
